...
style = ttk.Style()
style.configure("Custom.TButton", background="Blue", foreground="black")
...
score_label = ttk.Label(root, text="Score: 0/8", font=("Arial", 12))
score_label.place(x=400,y=15)

button_frame = ttk.Frame(root)
button_frame.pack(pady=10)


restart_button = ttk.Button(root, text="Restart",style="Custom.TButton", command=lambda: restart_quiz())
...
true_button = ttk.Button(button_frame, text="✔", style="Custom.TButton", command=lambda: answer_question("yes"))
true_button.pack(side=tk.LEFT, padx=10)

false_button = ttk.Button(button_frame, text="X",style="Custom.TButton", command=lambda: answer_question("no"))
